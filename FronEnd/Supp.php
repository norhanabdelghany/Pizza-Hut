...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/Categories1.css">
...
<div class="Supp" style="bottom: 150px">
    <?php
        ...
        {
            echo '<div class="addbook"> <a href="addBook.php">Add <i class="fas fa-food fa-1x" style=" color: black;"></i> Meal</a> </div>';
        }
    ?>
    <br>
    <br>
